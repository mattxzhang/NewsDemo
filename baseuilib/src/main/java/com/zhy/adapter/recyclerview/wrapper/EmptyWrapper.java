...
//                    holder = ViewHolder.createViewHolder(parent.getContext(), mLoadingView);
//                } else {
//                    holder = ViewHolder.createViewHolder(parent.getContext(), parent, mLoadingViewId);
//                }
//                return holder;
//            }
            if (mEmptyView != null) {
